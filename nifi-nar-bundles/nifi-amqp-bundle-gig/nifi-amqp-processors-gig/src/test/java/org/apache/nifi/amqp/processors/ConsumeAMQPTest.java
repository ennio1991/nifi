...
public class ConsumeAMQPTest {
    ...
    public void validateSuccessfullConsumeAndTransferToSuccess() throws Exception {
        ...
        try (AMQPPublisher sender = new AMQPPublisher(connection, mock(ComponentLog.class))) {
            ...
            ConsumeAMQP_GiG pubProc = new LocalConsumeAMQP(connection);
            TestRunner runner = TestRunners.newTestRunner(pubProc);
            runner.setProperty(ConsumeAMQP_GiG.HOST, "injvm");
            runner.setProperty(ConsumeAMQP_GiG.QUEUE, "queue1");
    ...
    public static class LocalConsumeAMQP extends ConsumeAMQP_GiG {
